...
char mqttTopicPrefix[64] = "/Space/Ship/Audio/Ambient/";//"/Egypt/Archives/espAudio/Ambient/";//
char mqttStatus[64] = "/Space/Ship/";
char mqttTopic[64];
int Folder = 2;
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), MQTT_USER, MQTT_PASSWORD)) {
      ...
      client.publish(mqttStatus, "Space ambient connected. Loading audio");
      // ... and resubscribe
...
void setup()
{
  ...
  client.publish(mqttStatus, "Test Library ambient ready");
}
